...
export default function AdminLayout({ 
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative overflow-x-hidden">
      ...
      {/* Sidebar for Mobile */}
      <AdminSidebar isCollapsed={!isMobileMenuOpen} isMobile onToggle={toggleMobileMenu} />
      ...
      >
        {/* Mobile Header */}
        <nav className="lg:hidden fixed top-0 inset-x-0 z-40 bg-white/70 backdrop-blur-xl border-b border-slate-200/50 px-6 py-4 flex items-center justify-between shadow-sm">
