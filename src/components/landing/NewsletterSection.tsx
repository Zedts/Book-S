...
export function NewsletterSection() {
  ...
  return (
    <section className="container mx-auto px-6 lg:px-12 mt-24 md:mt-40 reveal">
      <div className="bg-white/40 backdrop-blur-lg border border-white/60 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] rounded-3xl p-8 md:p-16 text-center relative overflow-hidden">
